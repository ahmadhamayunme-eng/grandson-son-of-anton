...
$stmt=$pdo->prepare("SELECT c.id,c.name,
  ...
  SUM(CASE WHEN t.status='Completed (Needs Manager Review)' THEN 1 ELSE 0 END) AS needs_manager
  FROM clients c
...
<div class="card p-3">
  <div class="table-responsive">
    <table class="table table-dark table-hover align-middle mb-0">
      <thead><tr><th>Client</th><th>Projects</th><th>Open Tasks</th><th>Needs Manager</th><th class="text-end">Open</th></tr></thead>
      <tbody>
