...
<style>
  ...
  /* ===== MOBILE (≤768px) =====
     Same defect as the Project Types/Statuses pages: the Current
     Statuses header clipped "Save Order", the Add form squeezed its
     input, and the 7-column list table overflowed. Stack the chrome and
     convert each status row to a card. */
