...
<?php $svPage = 'my_tasks'; include __DIR__ . '/partials/saved_views_bar.php'; ?>
      ...
      ?>
        <tr>
          ...
          <td style="text-align:right;">
            <?php if ($canFinalStatus): ?>
            <button type="button" class="open-btn" data-task-edit="<?= (int)$t['id'] ?>" style="margin-right:6px;">
